...
Revision ID: 54a06b713e60
Revises: 
Create Date: 2025-06-20 09:26:29.451054
...
def upgrade() -> None:
    ...
    # Skip auth.users table - already created by copy_auth_schema.py script
    ...
    sa.Column('assigned_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['role_id'], ['roles.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['auth.users.id'], name='fk_user_role_auth_user_id', ondelete='CASCADE', use_alter=True),
