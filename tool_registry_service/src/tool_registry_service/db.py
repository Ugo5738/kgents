"""
Database connection and session management for the Tool Registry Service.

This module sets up async SQLAlchemy connection to PostgreSQL using the
same patterns as in auth_service and agent_management_service.
"""
...
from tool_registry_service.logging_config import logger
...
engine: AsyncEngine = create_async_engine(
    ...
    connect_args={
        "application_name": "tool_registry_service",
