...
from tool_registry_service.models.tool import Tool, ToolCategory
from tool_registry_service.schemas.tool import ToolCreate, ToolSearchParams, ToolUpdate

logger = logging.getLogger(__name__)


async def create_tool(
    db: AsyncSession, tool_data: ToolCreate, owner_id: UUID
) -> Tool:
    """
    Create a new tool.
