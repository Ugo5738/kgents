...
Revision ID: 23bfef8c82e1
Revises: 
Create Date: 2025-08-10 13:13:14.066880
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "schema", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        ...
        sa.Column(
            "examples", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ["category_id"], ["tool_categories.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
    ...
    op.create_index(
        op.f("ix_tools_owner_id"), "tools", ["owner_id"], unique=False
    )
    op.create_index(
        op.f("ix_tools_tool_type"), "tools", ["tool_type"], unique=False
    )
    op.create_table(
        "tool_executions",
        ...
        sa.Column(
            "inputs", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_tool_executions_agent_id"),
        "tool_executions",
        ["agent_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_tool_executions_user_id"),
        "tool_executions",
        ["user_id"],
        unique=False,
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_tool_executions_user_id"), table_name="tool_executions"
    )
    op.drop_index(
        op.f("ix_tool_executions_tool_id"), table_name="tool_executions"
    )
    op.drop_index(op.f("ix_tool_executions_id"), table_name="tool_executions")
    op.drop_index(
        op.f("ix_tool_executions_agent_id"), table_name="tool_executions"
    )
    ...
    op.drop_table("tools")
    op.drop_index(
        op.f("ix_tool_categories_name"), table_name="tool_categories"
    )
