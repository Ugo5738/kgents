...
DB_HOST=$AGENT_DEPLOYMENT_SERVICE_POSTGRES_HOST
DB_PORT=$AGENT_DEPLOYMENT_SERVICE_POSTGRES_PORT
...
# Run the database setup for the agent_deployment_service
echo "Running Alembic migrations..."
python scripts/manage_db.py init
echo "Alembic migrations complete."

# Execute the main command (uvicorn)
echo "Starting Agent Deployment Service..."
exec "$@"