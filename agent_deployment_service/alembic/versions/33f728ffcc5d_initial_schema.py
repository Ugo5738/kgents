...
Revision ID: 33f728ffcc5d
Revises: 
Create Date: 2025-08-10 13:12:35.385780
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_deployments_agent_id"),
        "deployments",
        ["agent_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_deployments_agent_version_id"),
        "deployments",
        ["agent_version_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_deployments_id"), "deployments", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_deployments_status"), "deployments", ["status"], unique=False
    )
    op.create_index(
        op.f("ix_deployments_user_id"),
        "deployments",
        ["user_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_deployments_agent_version_id"), table_name="deployments"
    )
