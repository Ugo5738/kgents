...
async def test_create_agent_endpoint(
    test_client, mock_validate_token, agent_payload, test_user_id, mock_token
):
...
async def test_get_agents_endpoint(
    test_client, test_db_session, mock_validate_token, agent_payload, mock_token
):
...
async def test_update_agent_endpoint(
    test_client, test_db_session, mock_validate_token, agent_payload, update_payload, mock_token
):
