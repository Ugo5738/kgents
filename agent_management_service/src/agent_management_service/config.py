...
class Settings(BaseSettings):
    ...
    ENVIRONMENT: Environment = Field(Environment.DEVELOPMENT, alias="AGENT_MANAGEMENT_SERVICE_ENVIRONMENT")
    ...
    # Security
    AUTH_SERVICE_URL: str = Field("http://auth_service:8000", alias="AGENT_MANAGEMENT_SERVICE_AUTH_SERVICE_URL")
    TOKEN_URL: str = Field("/api/v1/auth/validate-token", alias="AGENT_MANAGEMENT_SERVICE_TOKEN_URL")

    # CORS Settings
    CORS_ORIGINS: List[str] = Field(["*"], alias="AGENT_MANAGEMENT_SERVICE_CORS_ORIGINS")

    # Database
    POSTGRES_SERVER: str = Field(..., alias="AGENT_MANAGEMENT_SERVICE_POSTGRES_SERVER")
    POSTGRES_USER: str = Field(..., alias="AGENT_MANAGEMENT_SERVICE_POSTGRES_USER")
    POSTGRES_PASSWORD: str = Field(..., alias="AGENT_MANAGEMENT_SERVICE_POSTGRES_PASSWORD")
    ...
    DATABASE_URL: Optional[PostgresDsn] = Field(None, alias="AGENT_MANAGEMENT_SERVICE_DATABASE_URL")
    ...
    LANGFLOW_API_URL: str = Field("http://langflow_ide:7860", alias="AGENT_MANAGEMENT_SERVICE_LANGFLOW_API_URL")
