...
from agent_management_service.schemas.agent_version import AgentVersionCreate, AgentVersionUpdate
...
async def create_agent_version(
    ...
    result = await db.execute(
        select(Agent)
        .where(and_(
            Agent.id == version_data.agent_id,
    ...
    if version_number is None:
        ...
        result = await db.execute(
            ...
            .where(AgentVersion.agent_id == version_data.agent_id)
        )
