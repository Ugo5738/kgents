...
# Default rate limits
DEFAULT_GENERAL_RATE_LIMIT = os.environ.get("AGENT_MANAGEMENT_SERVICE_GENERAL_RATE_LIMIT", "100/minute")
DEFAULT_AGENT_CREATE_RATE_LIMIT = os.environ.get("AGENT_MANAGEMENT_SERVICE_AGENT_CREATE_RATE_LIMIT", "10/minute")
DEFAULT_AGENT_UPDATE_RATE_LIMIT = os.environ.get("AGENT_MANAGEMENT_SERVICE_AGENT_UPDATE_RATE_LIMIT", "20/minute")
DEFAULT_VERSION_CREATE_RATE_LIMIT = os.environ.get("AGENT_MANAGEMENT_SERVICE_VERSION_CREATE_RATE_LIMIT", "30/minute")
DEFAULT_LANGFLOW_IMPORT_RATE_LIMIT = os.environ.get("AGENT_MANAGEMENT_SERVICE_LANGFLOW_IMPORT_RATE_LIMIT", "5/minute")
...
def setup_rate_limiting(app):
    ...
    if IS_TEST_MODE:
        ...
        logger.info(f"Rate limiting is enabled with the following limits: "
